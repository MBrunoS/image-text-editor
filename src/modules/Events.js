...
function init() {
  ...
  document
    .getElementById("texts-container")
  ...
  // Image changing
  document
    .getElementById("img-file-upload")
...
function bindElemToNode(container, node) {
  container
    .querySelector(`[data-handle=input]`)
    .addEventListener("keyup", handleInput);
  container
    .querySelector(`[data-handle=size]`)
    .addEventListener("change", handleSize);
  container
    .querySelector(`[data-handle=color]`)
    .addEventListener("input", handleColor);
  container
    .querySelector(`[data-handle=style]`)
    .addEventListener("click", handleStyle);
  container
    .querySelector(`[data-handle=center]`)
    .addEventListener("click", handleCenter);
  container
    .querySelector(`[data-handle=align]`)
    .addEventListener("click", handleAlign);
  container
    .querySelector(`[data-handle=movement]`)
    .addEventListener("click", handleMovement);
  container
    .querySelector(`[data-handle=shadow]`)
    .addEventListener("click", handleShadow);
  container
    .querySelector(`[data-handle=shadow-opacity]`)
    .addEventListener("input", handleShadowOpacity);
  container
    .querySelector(`[data-handle=shadow-x]`)
    .addEventListener("input", handleShadowX);
  container
    .querySelector(`[data-handle=shadow-y]`)
    .addEventListener("input", handleShadowY);
  container
    .querySelector(`[data-handle=shadow-blur]`)
    .addEventListener("input", handleShadowBlur);
  container
    .querySelector(`[data-handle=shadow-color]`)
    .addEventListener("input", handleShadowColor);
...
function getCanvasNode(elem) {
  // returns the text node from the canvas
